...
Problems live in the experience; solutions live in the system. A problem shows you what's wrong but not why, or what would make it right. The person who has it holds the most valuable signal and the narrowest view of the architecture, competing priorities, and second-order effects that shape solutions.

Treat feedback as diagnosis, not prescription. When someone says your work is wrong, investigate what they're responding to. When they tell you how to fix it, understand what they need rather than doing what they suggest. The problem they've identified is data. The solution they've proposed is a hypothesis about that need, aimed at the symptom they experienced rather than the cause you can address.

Critics of a solution often correctly identify the new problems it would create, even when their counter-proposal would fare no better. This essay is not exempt. It diagnoses a gap and prescribes a posture, and a posture is what's left when you can't supply the fix. A fix would have to be specific—this system, this constraint, this reader. The signal sits with whoever felt it, the capacity to act with whoever holds the system, and they are rarely the same person. Neither becomes the other by trying harder.
